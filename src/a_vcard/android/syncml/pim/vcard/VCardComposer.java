...
public class VCardComposer {
     ...
     * 
     * @param struct see more from ContactStruct class
     * @param vcardversion MUST be VERSION_VCARD21 /VERSION_VCARD30
     * @return vCard string
     * @throws VCardException struct.name is null /vcardversion not match
     */
     ...
     * 
     * @param str the string to be folded
     ...
     * 
     * @param bytes the binary string to be converted
     * @param type the type of the content
     * @param version the version of vcard
     */
